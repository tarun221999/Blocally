const urls = {
    ...
    SEND_PUSH_NOTIFICATIONS_ENT: 'SendPushNotificationsEnt',
...
const screenNames = {
    ...
    ADD_HOLIDAY_SCREEN: "ADD_HOLIDAY_SCREEN",
...
export {
    ...
    productOrderBy, scheduleTypes, dealStatuses, notificationTypes, isTotalBlock, favoriteType,
}