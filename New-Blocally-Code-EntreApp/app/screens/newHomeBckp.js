...
export default class UserHomeScreen extends Component {
    ...
    addFcmListener = () => {
            ...
            if (Platform.OS === constants.ANDROID) {
                ...
                if (data.type && data.type == notificationTypes.MESSAGE) {
                    if (constants.IS_CHAT_SCREEN &&
                        constants.CURRENT_CHAT_ID == data.messageId) {
         ...
         */
        // notifee.onBackgroundEvent((notificationOpen) => {
        //     // Get the action triggered by the notification being opened
        //     const action = notificationOpen.action;
        //     // Get information about the notification that was opened
        //     const notification = notificationOpen.notification;
            ...
            this.messageListener = messaging().onMessage((remoteMessage) => {
                ...
                if (data.type && data.type == notificationTypes.MESSAGE) {
                    if (constants.IS_CHAT_SCREEN &&
                        ...
                        this.createNotificationChannel(remoteMessage, true);
                    }
                } else {
                    this.createNotificationChannel(remoteMessage, true);
                }
    ...
    createNotificationChannel = async (notification, isDataMessage) => {
        // Create the channel
        ...
        if (notification) {
            this.showNotification(notification, isDataMessage);
        }
    }

    // display push notificatio to user
    showNotification = (notificationObj, isDataMessage) => {
        ...
        if (data.unreadMessagesCount) {
            ...
            let unreadAdminNotificationsCount = data.unreadAdminNotificationsCount;
            ...
            if (typeof unreadAdminNotificationsCount == 'string') {
                unreadAdminNotificationsCount = parseInt(unreadAdminNotificationsCount);
            }
        ...
        //     .setNotificationId(constants.FCM_GROUP_NOTIFICATION_ID)

        // const notification = new firebase.notifications.Notification()
        // if (isDataMessage) {
        //     notification.setNotificationId(notificationObj._messageId)
        //         .setTitle(data.title)
        //         .setBody(data.body)
        //         .setData(data);
        // } else {
        //     notification.setNotificationId(notificationObj._notificationId)
        //         .setTitle(notificationObj.title)
        //         .setBody(notificationObj.body)
        //         .setData(notificationObj.data);
        // }

        // if (Platform.OS === constants.ANDROID) {
        //     groupNotification
        //         .android.setChannelId(constants.FCM_CHANNEL_ID)
        //         .android.setSmallIcon('@mipmap/ic_notification_icon')
        //         .android.setAutoCancel(true)
        //         .android.setColor(colors.primaryHexColor)
        //         .android.setGroup(constants.FCM_GROUP_ID)
        ...
        //         .android.setSmallIcon('@mipmap/ic_notification_icon')
        //         .android.setTag(constants.FCM_TAG)
        //         .android.setPriority(firebase.notifications.Android.Priority.Max)
        //         .android.setDefaults(firebase.notifications.Android.Defaults.Sound | firebase.notifications.Android.Defaults.Vibrate)
        ...
        //     messaging().displayNotification(groupNotification);
        // }
        // notifee.displayNotification(
        //     {
        //         title: notificationObj.data.title,
