...
import {
    getCommonParamsForAPI, getCurrentUTCDateTime, getCurrentISODateTime, alertDialog, getCurrentLocalDateTime,
...
export default class EmployeeHomeScreen extends Component {
    ...
    // increment the local count for hot deals
    ...
    // increment the local count for bonus cards
