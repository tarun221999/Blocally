    ...
    render() {
        return (
            <TouchableOpacity
                ...
                {this.props.icon &&
                    <ImageComponent source={this.props.icon}
                        style={[{ marginRight: 10 }, this.props.iconStyle]} />
                }
                <Text
                ...
                {
                    this.props.rightIcon && <ImageComponent source={this.props.rightIcon}
                        style={[{ marginLeft: 10 }, this.props.rightIconStyle]} />
                }
            </TouchableOpacity>
        );
    }
